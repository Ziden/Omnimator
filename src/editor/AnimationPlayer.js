...
class AnimationPlayer {
    ...
    constructor(animation, body) {
        ...
        this.frames = this.animation.frameData;
    ...
    start() {
        this.frame = 0;
        const interpolatedFrames = this.animation.fillNewInterpolatedFrames(this.interpolation, this.frames);
        this.frames = interpolatedFrames;
    }

    stop() {
        Events.fire("onAnimationStop");
    }
